*&---------------------------------------------------------------------*
*& Report Z_S03_OO_VERERBUNG_AUFGABE
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT Z_S03_OO_VERERBUNG_AUFGABE.
...
*  Das erzeugen einer Instanz in einer abstrakten Klasse ist nicht erlaubt.
*  * OBERKLASSE
**********************************************************************
...
*lo_rechnung = new lcl_rechnung( ). "Abstrakte Klassen können nicht instanziert werden!
