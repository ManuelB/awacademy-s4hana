CLASS zcl_amdp_demo_s10 DEFINITION
  ...
  PROTECTED SECTION.
    TYPES:
      BEGIN OF ty_result_line,
        ...
        new_currency      TYPE scarr-currcode,
...
CLASS zcl_amdp_demo_s10 IMPLEMENTATION.
  METHOD get_flights BY DATABASE PROCEDURE
    ...
    USING
      sflight
      scarr
      zcl_amdp_demo_s10=>convert_currency.
    ...
    call "ZCL_AMDP_DEMO_S10=>CONVERT_CURRENCY"( :flights, result );
