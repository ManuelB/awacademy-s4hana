...
*&
*&---------------------------------------------------------------------*
REPORT zbcs12_inheritance_base.
...
*     / 'Weight'(003) , AT c_pos_1 mv_weight LEFT-JUSTIFIED,
*     / 'Tank Capacity'(004) , AT c_pos_1 mv_tankcap LEFT-JUSTIFIED,
    / 'Number of seats'(005) , AT c_pos_1 mv_seats  LEFT-JUSTIFIED.
...
DATA: go_airplane  TYPE REF TO lcl_passenger_plane,
      gt_airplanes TYPE TABLE OF REF TO lcl_passenger_plane,
      gv_count     TYPE i.
...
*-------------------------
  ...
  gv_count = lcl_passenger_plane=>get_n_no_airplanes( ).
  SKIP 2.
