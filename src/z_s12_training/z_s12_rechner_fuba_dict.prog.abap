...
*&
*&---------------------------------------------------------------------*
REPORT z_s12_rechner_fuba_dict.

*************************************************************************************************************************************************
*Rechner mit 2 Rechenoperationen
*************************************************************************************************************************************************
PARAMETERS:
  a1  TYPE Z12TS_ty_zahl DEFAULT 3,
  op1 TYPE Z12TS_ty_operator DEFAULT '+',
  b1  TYPE Z12TS_ty_zahl DEFAULT 4,
  a2  TYPE Z12TS_ty_zahl DEFAULT 5,
  op2 TYPE Z12TS_ty_operator DEFAULT '*',
  b2  TYPE Z12TS_ty_zahl DEFAULT 7.
*
DATA:
      res TYPE i.
*1. Berechnung
CALL FUNCTION 'ZS12_RECHNEN'
  EXPORTING
    i_a            = a1
    i_op           = op1
    i_b            = b1
