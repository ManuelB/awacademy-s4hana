...
METHODS:
      constructor
        IMPORTING
          iv_name      TYPE string
          iv_planetype TYPE saplane-planetype
          mv_cargo      TYPE scplane-cargomax.
...
CLASS lcl_passenger_airplane DEFINITION INHERITING FROM lcl_airplane.
  ...
  PRIVATE SECTION.
    CLASS-DATA:
      mv_seats TYPE sflight-seatsmax.
...
CLASS lcl_passenger_airplane IMPLEMENTATION.
  ...
  METHOD display_attributes.
    ...
    WRITE:
     / 'Maximum seats'(006) , AT c_pos_1 mv_seats LEFT-JUSTIFIED.
    .
...
DATA: go_airplane    TYPE REF TO lcl_airplane,
      go_P_airplane  TYPE REF TO lcl_passenger_airplane,
      gt_airplanes   TYPE TABLE OF REF TO lcl_airplane,
      gt_p_airplanes TYPE TABLE OF REF TO lcl_airplane,
      gv_count       TYPE i.

START-OF-SELECTION.

  lcl_airplane=>display_n_o_airplanes( ).
  lcl_passenger_airplane=>display_n_o_airplanes( ).
...
*-------------------------
  ...
  LOOP AT gt_airplanes INTO go_airplane.
    go_P_airplane->display_attributes( ).
  ENDLOOP.
...
*-------------------------
  ...
  CREATE OBJECT go_p_airplane
    ...
    EXCEPTIONS
      wrong_planetype = 1.
  IF sy-subrc = 0.
    APPEND go_p_airplane TO gt_p_airplanes.
  ENDIF.
