CLASS ZCk_AMDP_DEMO_S01 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zck_amdp_demo_s01 IMPLEMENTATION.
  METHOD get_flights BY DATABASE PROCEDURE
    ...
    USING
      sflight
      scarr
      zck_amdp_demo_S01=>convert_currency.
    ...
    call "ZCK_AMDP_DEMO_S01=>CONVERT_CURRENCY"( :flights, result );
