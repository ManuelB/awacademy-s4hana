*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZS01_VPF_PFLIGHT
*   generation date: 03/30/2022 at 09:40:06
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZS01_VPF_PFLIGHT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZS01_VPF_PFLIGHT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZS01_VPF_PFLIGHT_EXTRACT
TOTAL = ZS01_VPF_PFLIGHT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZS01_VPF_PFLIGHT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZS01_VPF_PFLIGHT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZS01_VPF_PFLIGHT_EXTRACT
TOTAL = ZS01_VPF_PFLIGHT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZS01_VPF_PFLIGHT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZS01_VPF_PFLIGHT'
...
TOTAL = ZS01_VPF_PFLIGHT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZS01_VPF_PFLIGHT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZS01_VPF_PFLIGHT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZS01_VPF_PFLIGHT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZS01_VPF_PFLIGHT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZS01_VPF_PFLIGHT_EXTRACT
TOTAL = ZS01_VPF_PFLIGHT_TOTAL
