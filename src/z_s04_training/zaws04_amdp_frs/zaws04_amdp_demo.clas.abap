CLASS zaws04_amdp_demo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zaws04_amdp_demo IMPLEMENTATION.
  ...
  METHOD get_flights BY DATABASE PROCEDURE
    ...
    USING
      sflight
     scarr
      zaws04_amdp_demo=>convert_currency.
    ...
    call "ZAWS04_AMDP_DEMO=>CONVERT_CURRENCY"( :flights, result );
  ENDMETHOD.
