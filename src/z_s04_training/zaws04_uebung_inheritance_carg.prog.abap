REPORT zaws04_uebung_inheritance_carg .
...
*
*    TYPES:
*    ty_cplanetype TYPE TABLE OF scplane
*      WITH NON-UNIQUE KEY planetype.
*
*    DATA: mv_cplanetype TYPE scplane-planetype,
*          gt_cplanetype TYPE ty_cplanetype.
*    METHODS:
*      display_cargomax
*        IMPORTING
*          iv_type  TYPE scplane-planetype
*        EXPORTING
...
CLASS lcl_cargo_plane IMPLEMENTATION.
  ...
  METHOD display_attributes.
    ...
    WRITE: / 'Maximales Ladevolumen', AT c_pos_1 mv_cargo LEFT-JUSTIFIED.
  ENDMETHOD.

*  METHOD display_cargomax.
*    DATA: ls_cplanetype TYPE scplane.
*
*    READ TABLE gt_cplanetype INTO ls_cplanetype
*    WITH TABLE KEY planetype = iv_type
*    TRANSPORTING cargomax.
*
*    IF sy-subrc = 0.
*      ev_cargo = ls_cplanetype-cargomax.
*    ELSE.
*      RAISE wrong_planetype.
*    ENDIF.
*  ENDMETHOD.
...
*    ENDIF.
*    super->display_attributes( ).
*    WRITE: / 'Maximales Ladevolumen', AT c_pos_1 mv_cargo.
*  ENDMETHOD.
