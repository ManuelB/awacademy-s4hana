...
*&
*&---------------------------------------------------------------------*
REPORT zbcs05_inheritance_base2.
...
CLASS lcl_cargo_plane DEFINITION INHERITING FROM lcl_airplane.
  ...
  TYPES:
    ty_cargo TYPE TABLE OF scplane
    WITH NON-UNIQUE KEY planetype.

    data:
  gt_cargo    TYPE ty_cargo.

    CONSTANTS:
    c_pos_2 TYPE i VALUE 30.
...
*    DATA: ls_cargo TYPE scplane.
*
*    READ TABLE gt_cargo INTO ls_cargo
*    WITH TABLE KEY planetype = iv_type
*    TRANSPORTING cargomax.
*
*    IF sy-subrc = 0.
*      ev_cargo = ls_cargo-cargomax.
*    ELSE.
*      RAISE wrong_planetype.
*    ENDIF.
*    endmethod.
...
*-------------------------
  ...
  ENDLOOP.
    ...
    LOOP AT gt_cargo INTO go_cargo.
