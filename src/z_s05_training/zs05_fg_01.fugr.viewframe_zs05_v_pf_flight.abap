*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZS05_V_PF_FLIGHT
*   generation date: 03/30/2022 at 09:38:57
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZS05_V_PF_FLIGHT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZS05_V_PF_FLIGHT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZS05_V_PF_FLIGHT_EXTRACT
TOTAL = ZS05_V_PF_FLIGHT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZS05_V_PF_FLIGHT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZS05_V_PF_FLIGHT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZS05_V_PF_FLIGHT_EXTRACT
TOTAL = ZS05_V_PF_FLIGHT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZS05_V_PF_FLIGHT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZS05_V_PF_FLIGHT'
...
TOTAL = ZS05_V_PF_FLIGHT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZS05_V_PF_FLIGHT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZS05_V_PF_FLIGHT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZS05_V_PF_FLIGHT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZS05_V_PF_FLIGHT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZS05_V_PF_FLIGHT_EXTRACT
TOTAL = ZS05_V_PF_FLIGHT_TOTAL
