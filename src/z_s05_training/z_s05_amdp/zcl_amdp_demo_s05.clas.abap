CLASS ZCL_AMDP_DEMO_S05 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_AMDP_DEMO_S05 IMPLEMENTATION.
  ...
  SFLIGHT
  SCARR
  zcl_amdp_demo_s05=>convert_currency.
...
*  on (f.carrier_id = c.carrier_id)
     ...
     call "ZCL_AMDP_DEMO_S05=>CONVERT_CURRENCY"( :flights, result );
