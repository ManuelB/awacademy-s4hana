CLASS zcl_amdp_demo_xxx_s07 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_amdp_demo_xxx_s07 IMPLEMENTATION.
...
ENDMETHOD.
 ...
 METHOD get_flights BY DATABASE PROCEDURE
  ...
  USING
    sflight
    scarr
    ZCL_AMDP_DEMO_XXX_S07=>convert_currency.
  ...
  call "ZCL_AMDP_DEMO_XXX_S07=>CONVERT_CURRENCY"( :flights, result );
