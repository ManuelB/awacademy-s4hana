*&---------------------------------------------------------------------*
*& Report ZBCS01_INHERITANCE_BASE
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zbcs01_inheritance_base.
...
*
    ...
    CLASS-METHODS:"staticmethod attrib (classe zu ferfug )nur mit create object
      class_constructor,
...
CLASS lcl_airplane IMPLEMENTATION.
  ...
  METHOD get_technical_attributes.
    ...
    TRANSPORTING weight tankcap."hier noch cargo dazu
